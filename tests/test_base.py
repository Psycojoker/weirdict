...
class BaseTestCase(unittest.TestCase):
    ...
    def test_dict_dropin_replacement(self):
        """Make sure we implement all of dict's methods."""
        dict_methods = set(dir(dict))
        our_methods = set(dir(SimpleNormalizedDict))
        self.assertFalse(dict_methods - our_methods)
